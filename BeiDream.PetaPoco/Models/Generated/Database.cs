...
//     Connection String:      `Data Source=ZHAOLIANG-PC\SQLEXPRESS;Initial Catalog=BeiDreamEasyUi;User ID=sa;password=**zapped**;Pooling=False`
//     Schema:                 ``
//     Include Views:          `False`
...
namespace PetaPocoORM
{
    ...
    public partial class BeiDream_Menu : PetaPocoHelper.Record<BeiDream_Menu>  
    {
		...
		[Column] public int SortId { get; set; }
		...
		[Column] public string PinYin { get; set; }
